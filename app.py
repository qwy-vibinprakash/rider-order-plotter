...
# ---------------------------------------------------------------------------
# DB — Overall Report (per-day stats)
# ---------------------------------------------------------------------------
...
tab_plot, tab_report, tab_coverage, tab_presence, tab_overall = st.tabs([
    "🗺 Rider Plot", "📊 Notified Orders Report", "📋 Zone Coverage", "👥 Rider Presence", "📈 Overall Report"
])
...
with tab_overall:
    ...
    if ov_fetch_btn:
        if ov_start > ov_end:
            ...
            # Summary metrics across the date range
